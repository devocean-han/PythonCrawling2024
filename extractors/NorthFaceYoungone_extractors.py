'''
North Face Youngone(노스페이스 영원) 추출자들을 모아놓은 모듈. 
...
logger = logging.getLogger('NorthFaceYoungone.Extractors')
SITE_OFFICIAL = 'NorthFaceYoungone'


@export_strategy(SITE_OFFICIAL)
class NorthFaceYoungoneMetadataExtractor(I.MetadataExtractor):
...
@export_strategy(SITE_OFFICIAL)
class NorthFaceYoungoneProductNameKoreanExtractor(I.ProductNameKoreanExtractor):
    def __init__(self) -> None:
...
@export_strategy(SITE_OFFICIAL)
class NorthFaceYoungoneProductNameExtractor(I.ProductNameExtractor):
    def __init__(self) -> None:
        self.product_name_selectors = {
            'h1': 'h1.product-name', 
        }
...
@export_strategy(SITE_OFFICIAL)
class NorthFaceYoungonePriceExtractor(I.PriceExtractor):
    def __init__(self) -> None:
        pass
    ...
    def get_price(self, soup) -> str:
        try:
            # 메타데이터에서 추출
            metadataExtractor = NorthFaceYoungoneMetadataExtractor()
...
@export_strategy(SITE_OFFICIAL)
class NorthFaceYoungoneImagesExtractor(I.ImagesExtractor):
    def __init__(self) -> None:
...
@export_strategy(SITE_OFFICIAL)
class NorthFaceYoungoneSizeOptionsExtractor(I.SizeOptionsExtractor):
    def __init__(self) -> None:
        pass
...
@export_strategy(SITE_OFFICIAL)
class NorthFaceYoungoneDescriptionImagesExtractor(I.DescriptionImagesExtractor):
    def __init__(self) -> None:
...
@export_strategy(SITE_OFFICIAL)
class NorthFaceYoungoneDescriptionsExtractor(I.DescriptionsExtractor):
    def __init__(self) -> None:
...
# @export_strategy(SITE_OFFICIAL)
class NorthFaceYoungoneColorNameExtractor(I.ColorNameExtractor):
    def __init__(self) -> None:
        pass
...
@export_strategy(SITE_OFFICIAL)
class NorthFaceYoungoneColorUrlsExtractor(I.ColorUrlsExtractor):
    def __init__(self) -> None:
